...
Конфигуриемый http-сканер. Позволяет просканировать список URL'ов на наличие определенных эндпоинтов, отправляя различные запросы (GET, POST и тд). Может обходить проверку от Cloudflare.
